...
bool SoftwareSerial::listen() {
  if (active_listener != this) {
    ...
    setRXTX(true);
    // printf("li %d active_in %d active_out %d tx %d rx %d\r\n", _half_duplex, active_in, active_out, _receivePin, _transmitPin);
...
/* static */
void SoftwareSerial::handleInterrupt(HardwareTimer*) {
...
int SoftwareSerial::read() {
  //printf("re %d active_in %d active_out %d tx %d rx %d\r\n", _half_duplex, active_in, active_out, _receivePin, _transmitPin);
